...
// Defines the connect wallet function, with the message for the user to sign when connecting.
...
<>
  ...
  {/* The modal window with the wallet information is defined below. */}
  <Modal
